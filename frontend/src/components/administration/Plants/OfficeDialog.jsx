        ...
        <Dialog
            ...
            header={
                <div className="text-lg sm:text-xl font-semibold text-slate-800 pb-2">
                    {office === undefined ? "Add New Office" : "Edit Office"}
                </div>
            }
        >
            <Formik
                ...
                {({ values }) => (
                    <Form className="space-y-4 sm:space-y-6 p-3 sm:p-4">
                        <div className="space-y-3 sm:space-y-4">
                            <div>
                                ...
                                <Field
                                    name="name"
                                    type="text"
                                    className="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-slate-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 border-t border-slate-200">
                            <button
                                type="submit"
                                className="w-full sm:flex-1 px-4 sm:px-6 py-2.5 sm:py-3 bg-amber-600 hover:bg-amber-700 text-white text-sm sm:text-base rounded-lg transition-all duration-200 font-medium"
                            >
                                {office === undefined
                                    ? "Create Office"
                                    : "Save Changes"}
