...
export const PlantCard = ({ plant, users, onClick }) => {
    const administrator = users.find((user) => user.id === plant.administrator);
        ...
        >
            <div className="flex-1 p-4 sm:p-6">
                <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-indigo-100 flex items-center justify-center">
